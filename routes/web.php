...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/manage-inventories', ListInventories::class)->name('enventories.index');
    Route::get('/edit-inventory/{record}', EditInventory::class)->name('inventory.update');
    Route::get('/edit-inventory', CreateInventory::class)->name('inventory.create');
    ...
    Route::get('/customer-user/{record}', EditCustomer::class)->name('customer.update');
    Route::get('/customer-user', CreateCustomer::class)->name('customer.create');
